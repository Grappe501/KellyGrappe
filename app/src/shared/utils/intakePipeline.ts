...
export async function processIntake(params: ProcessIntakeParams): Promise<{
  ...
  void tryEnqueueServerFollowUp({
    ...
    followUp: {
      ...
      facebookProfileName: safeTrim(follow.facebookProfileName) || null,
      facebookHandle: safeTrim(follow.facebookHandle) || null,
      facebookUrl: safeTrim(follow.facebookUrl) || null,
    },
